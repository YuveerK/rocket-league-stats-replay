      ...
      <div className="anim-fade-in">
        ...
        >
          <div className="grid grid-cols-1 gap-3 md:grid-cols-4">
            <HeroMetric label="Final Score" value={`${blueGoals} - ${orangeGoals}`} color="#94a3b8" Icon={BarChart3} />
            <HeroMetric label="Total Shots" value={totalShots} color="#38bdf8" />
            <HeroMetric label="Total Demos" value={totalDemos} color="#f43f5e" />
            <HeroMetric label="Match Time" value={formatDuration(data?.match?.totalSecondsPlayed)} color="#a78bfa" Icon={Clock} />
          </div>
